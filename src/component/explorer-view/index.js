...
const ExplorerView = () => {
  ...
  return (
    <div className="flex h-screen w-full">
      <div className="w-92 bg-red-400 text-black-400 h-screen overflow-auto p-2 flex flex-col">
      ...
      <div className="flex-1 px-1 overflow-auto w-full bg-slate-300 border-l-4 border-gray-500">
        {selectedFile && selectedFile.type === 'file' && (
          <div>
            <div className="flex items-center">
              <div className='bg-indigo-950 inline-block flex items-center p-2 px-4'>
            ...
            <textarea
              className="text-black p-4 w-full h-80 bg-black-700 "
              value={editedContent}
