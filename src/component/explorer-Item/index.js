...
const ExplorerItem = ({ fileAndFolder, setFileExplorerData, onSelectFile }) => {
  ...
  if (fileAndFolder.type === "folder") {
    return (
      <div>
        <div className="cursor-pointer hover:bg-red-700 p-1 flex items-center justify-between">
  ...
  return (
    <div
      className=" flex items-center justify-between cursor-pointer hover:bg-red-700 p-1 flex items-center"
